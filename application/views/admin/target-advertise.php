      ...
      <div class="row">
              ...
              <div class="widget-content padded"><br>
                <form action="#" class="form-horizontal">
                  <img src="<?php echo base_url();?>assets/images/target.png" style="width: 50%"><br><br>
                  
                  <div class="form-group">
                    <label class="control-label col-md-2"> Campaign Name :- </label>
                    <div class="col-md-9">
                     <label class="control-label col-md-2"> Campaign 1  </label>
                    </div>
                  </div>
                  
                  <div class="form-group">
                    <label class="control-label col-md-2"> Ad Name :- </label>
                    <div class="col-md-9">
                      <label class="control-label col-md-2"> Campaign 2 </label>
                    </div>
                  </div>
             ...
             <a href="<?php echo base_url(); ?>admin/view_admin_advertisment"><button type="button" class="btn-lg btn-primary"> Back </button></a>
             </div>
        </div>
