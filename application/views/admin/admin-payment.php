      ...
      <div class="page-title"></div>
		<div class="row">
         ...
         <div class="head-design"> 
		      <div class="heading">
		        <i class="glyphicon glyphicon-usd"></i>Current Payment
		      </div>
			      <div class="row">
          ...
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
             ...
             <!-- <i class="fa fa-fw fa-bullhorn"></i>Ads Details<a class="btn btn-sm btn-primary-outline pull-right" href="http://www.google.com" id="add-row"><i class="fa fa-plus"></i>Add</a> -->
                <i class="glyphicon glyphicon-usd"></i>Payment History
              </div>
                ...
                <table class="table table-bordered table-striped" id="datatable-editable">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a class="" href="<?php echo base_url() ?>admin/payment_invoice"><i class="fa fa-eye"></i></a>
                      </td>
                    </tr>
                    <tr>
                      <td>
