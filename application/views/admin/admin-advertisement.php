			      	...
			      	<div class="widget-content padded"><br>
                        ...
                        <?php } ?>  
				          ...
				          <div class="form-group">
				            ...
				            <div class="col-md-7">
				              <label class="radio-inline"><input name="status" type="radio" value="active"><span>Active</span></label>
          ...
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
             ...
             <!-- <i class="fa fa-fw fa-bullhorn"></i>Ads Details<a class="btn btn-sm btn-primary-outline pull-right" href="http://www.google.com" id="add-row"><i class="fa fa-plus"></i>Add</a> -->
                ...
                <i class="fa fa-fw fa-bullhorn"></i>Ads Details<a class="btn btn-sm btn-primary-outline pull-right" href="<?php echo base_url();?>admin/view_add_admin_advertisement" id=""><i class="fa fa-plus"></i>Add</a>
              </div>
                ...
                <table class="table table-bordered table-striped" id="datatable-editable">
                  ...
                  <?php foreach($get_advertisment_details as $data) {  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url();?>admin/view_edit_admin_advertisement/<?php echo $data['advertise_id']; ?>"><i class="fa fa-pencil"></i></a>
                      </td>
                      <td>
                      ...
                      <td>
                        <a class="span_id" href="<?php echo base_url() ?>admin/view_target_advertise"><i class="fa fa-sitemap"> <span class="hidden" id="ading_id"> <?php echo $data['advertise_id']; ?> </span> <span class="hidden" id="campaign_title"> <?php echo $data['title']; ?> </span> <span class="hidden" id="ads_title"> <?php echo $data['ad_title']; ?> </span> </i> </a>
                      </td>
                    </tr>
