		        ...
		        <?php foreach($get_advertisment as $advertisment_details) { ?>
		            	...
		            	<div class="col-md-7" style="">
				            ...
				            <div class="video-player">
									<div id="data-vid" class="large-8 columns">
										<video style="position: absolute; top: 20px; left: 5%; width: 100%;" controls>
											<source id="vid-source" src="<?php echo base_url($advertisment_details['ad_file']); ?>" type="video/mp4">
										</video>
									</div>
				            </div><br><br>
				            <input type="file" id="the-video-file-field" name="file_name" accept="image/*" value="<?php echo $advertisment_details['ad_file']; ?>">
		          ...
		          <div class="form-group">
		            ...
		            <div class="col-md-7">
		              ...
		              <a href="<?php echo base_url();?>admin/view_admin_advertisment"> <button class="btn btn-default-outline" type="button">  Cancel </button></a>
		            </div>
		          </div>
		          <?php } ?>
		        </form>
