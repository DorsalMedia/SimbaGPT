		  ...
		  <div class="col-lg-12">
		    ...
		    <div class="widget-container fluid-height clearfix">
              ...
              foreach ($result_data as $final_data) {
				...
				<?php /* end changes for Client feedback - 1/5 task and $sum_t take from header Balance ( based on budget used ) value */
					}
					?>
		            ...
		            <div class="form-group">
			            <div class="col-md-7">
			              <input class="form-control" placeholder="Enter Budget" type="number"  min="1" max="999999999" name="budget">
			            </div>
		          	</div>
		          <div class="form-group">
			            <label class="control-label col-md-2"> Status </label>
			            <div class="col-md-7">
			              <label class="radio"><input checked="" name="status" type="radio" value="active"><span>Active</span></label>
			              <label class="radio"><input name="status" type="radio" value="inactive"><span>Inactive </span></label>
			            </div>
				    </div>
		          <div class="form-group">
		            ...
		            <div class="col-md-7">
		              ...
		              <a href="<?php echo base_url();?>common_admin/view_admin_campaigns"> <button class="btn btn-default-outline" type="button">  Cancel </button></a>
		            </div>
		          </div>
		        </form>
		      </div>
