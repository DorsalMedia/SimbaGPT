...
Summary :- Seperate function for getting header and footer libraries and loading files
...
if(!function_exists('get_menu_bar')):
	function get_menu_bar(){
		ob_start();
		include_once('includes/header/admin-menu-bar.php');
		return ob_get_clean();
	}
endif;
...
if(!function_exists('get_top_bar')):
	function get_top_bar(){
		ob_start();
		include_once('includes/header/admin-top-bar.php');
		return ob_get_clean();
	}
endif;
