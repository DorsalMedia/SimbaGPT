...
summary : loading dashboard home page.
...
<div class="container-fluid">
        ...
        <!-- Statistics -->
        <!-- change don for Rydlr 15_12_2017 comments (1) document-->
        <div class="row main-content"  style="height: 84vh; text-align: center; background: #fff; margin-bottom: 12px;">

  <h3 style="text-align: center;margin-top: 20px;">Welcome</h3>

  <a class="btn btn-sm btn-primary-outline" href="<?php echo base_url()?>common_admin/view_add_admin_advertisement"><i class="fa fa-plus"></i>Create an Ad </a>
         <!-- <div class="col-lg-12">
          ...
          <div class="col-md-6">
            <div class="widget-container scrollable chat" style="height: 427px;">
              ...
              <div class="widget-content padded">
                <ul>
                  <li>
                    <img width="30" height="30" src="<?php echo base_url();?>assets/images/avatar-male.jpg" />
                    <div class="bubble">
                  ...
                  <li class="current-user">
                    <img width="30" height="30" src="<?php echo base_url();?>assets/images/avatar-female.jpg" />
                    <div class="bubble">
